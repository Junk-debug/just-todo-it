  ...
  return (
    <Tabs asChild value={pathname} className="h-full">
      <div className="!h-dvh w-full flex flex-col">
        {children}
        <TabsList className="flex w-full justify-evenly fixed bottom-0 md:hidden py-2 h-auto min-h-[4.25rem] rounded-none border-b-[calc(env(safe-area-inset-bottom)+0.5rem)] border-muted">
